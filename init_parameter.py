...
def init_model():
    ...
    parser.add_argument("--cache_dir", default="./for_cache_three", type=str, help="Path to save the cache data.")
    
    # hyperparameters
    parser.add_argument("--feat_dim", default=768, type=int, help="The feature dimension.")

    parser.add_argument("--output_dim", default=128, type=int, help="The feature dimension.")
